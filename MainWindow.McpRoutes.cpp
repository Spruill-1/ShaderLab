...
{"name":"graph_add_node","description":"Add a built-in D2D effect node by name, or a ShaderLab analysis/source effect (e.g. Luminance Heatmap, CIE Chromaticity Plot, Gamut Highlight, Waveform Monitor, Vectorscope, False Color, Delta E Comparator, Gamut Coverage, Gamut Mapper, Gamut Viewer, Gamut Source, Color Checker, Zone Plate, Gradient Generator, HDR Test Pattern)","inputSchema":{"type":"object","properties":{"effectName":{"type":"string","description":"Effect name e.g. Gaussian Blur"}},"required":["effectName"]}},
